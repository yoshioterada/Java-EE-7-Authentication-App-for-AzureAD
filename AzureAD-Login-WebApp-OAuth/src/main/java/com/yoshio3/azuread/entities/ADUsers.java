...
public class ADUsers {
     ...
     */
    public void setValue(ADUser[] value) {
        this.value = value;
    }

    @Override
    public String toString() {
        return "ALL ADUsers{" + "metadata=" + metadata + ", odata_type=" + odata_type + ", value=" + Arrays.toString(value) + '}';
    }
